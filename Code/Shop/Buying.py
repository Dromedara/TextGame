import Code.Shop.CreateStaff as CreateStaff
        ...
        if a == 'artefacts':
            while True:
                ...
                if choice == 'stop':
                   ...
                   bought_artefacts[selling_artefacts[choice].key](selling_artefacts[choice])
            ...
            while True:
                ...
                if choice == 'stop':
                    ...
                    bought_potions[selling_artefacts[choice].key](selling_potions[choice])
